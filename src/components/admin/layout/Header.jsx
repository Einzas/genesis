...
const Header = () => {
  return (
    <header className="relative">
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between p-4 md:px-8 lg:px-12 w-full">
      ...
      <hr className="absolute bottom-0 w-full border-b border-gray-200" />
    </header>
  );
};
